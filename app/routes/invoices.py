...
def get_receipt_settings(company_id=None):
    ...
    try:
        ...
        # Merge with defaults
        defaults = {
            'company_name': settings_dict.get('company_name', 'YOUR STORE'),
            ...
            'show_qr_code': settings_dict.get('show_qr_code', 'true').lower() == 'true',
...
def save_settings_api():
    ...
    try:
        ...
        settings_keys = [
            'company_name', 'business_address', 'business_city', 'business_phone',
            'business_email', 'business_gst', 'thank_you_message', 'warranty_info',
            'footer_text', 'receipt_logo', 'default_receipt_format', 'show_qr_code',
            'receipt_type'
        ]
