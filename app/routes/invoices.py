...
def get_receipt_settings(company_id=None):
    ...
    try:
        ...
        defaults = {
            ...
            'receipt_logo': settings_dict.get('receipt_logo') or settings_dict.get('logo_path') or settings_dict.get('receipt_logo_path', ''),
...
def preview_a4_invoice():
    ...
    sample_data = {
        ...
        'subtotal': '$5,150.00',
        'discount': '-$315.00',
        'discount_total': 315.00,
        'discount_percentage': 5.77,
        'tax': '$386.80',
        'tax_amount': 386.80,
        'tax_rate': 7.51,
        'total': '$5,221.80',
